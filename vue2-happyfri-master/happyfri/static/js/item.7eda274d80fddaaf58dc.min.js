webpackJsonp([0, 3], {
  28: function (e, t, A) {
    ...
    var n = A(31), a = i(n), o = A(27);
    t.default = {
      name: "itemcontainer",
      data: function () {
        return {itemId: null, choosedNum: null, choosedId: null}
      },
      props: ["fatherComponent"],
      computed: (0, o.mapState)(["itemNum", "level", "itemDetail", "timer"]),
      methods: (0, a.default)({}, (0, o.mapActions)(["addNum", "initializeData"]), {
        nextItem: function () {
          null !== this.choosedNum ? (this.choosedNum = null, this.addNum(this.choosedId)) : alert("您还没有选择答案哦")
        ...
        }, choosed: function (e, t) {
          this.choosedNum = e, this.choosedId = t
        }, submitAnswer: function () {
          null !== this.choosedNum ? (this.addNum(this.choosedId), clearInterval(this.timer), this.$router.push("score")) : alert("您还没有选择答案哦")
        }
      }),
      created: function () {
        this.initializeData(), document.body.style.backgroundImage = "url(./static/img/1-1.jpg)"
      }
    }
  }, 30: function (e, t, A) {
    e.exports = {default: A(32), __esModule: !0}
  }, 31: function (e, t, A) {
    "use strict";
    ...
    var n = A(54), a = i(n);
    t.default = {
      name: "item", components: {itemcontainer: a.default}, created: function () {
        this.$store.commit("REMBER_TIME")
      }
    }
  }, 128: function (e, t, A) {
    t = e.exports = A(18)(), t.push([e.id, "", "", {
      version: 3,
      sources: [],
      names: [],
      mappings: "",
    ...
    A(133);
    var i = A(13)(A(72), A(147), null, null);
    e.exports = i.exports
  }, 147: function (e, t) {
    e.exports = {
      render: function () {
        var e = this, t = e.$createElement, A = e._self._c || t;
        return A("div", [A("itemcontainer", {attrs: {"father-component": "item"}})], 1)
      }, staticRenderFns: []
    }
  }
});
